---
layout: post
title: "Back-of-the-Envelope: The Mean-Reverting VIX Model"
date: 2026-03-09
mathjax: true
categories: wealth
---

[View on GitHub](https://github.com/juleshenry/rafaga)
...
In the OU process, the path of $Y_t$ is continuous. It has no jumps. In reality, the VIX can leap from 15 to 30 overnight (February 5, 2018, anyone?). A continuous process cannot produce this behavior without an absurdly large $\sigma$, which would then overestimate volatility the rest of the time.
