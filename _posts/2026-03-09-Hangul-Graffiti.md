...
|----------|----------|---------|
| 은/는 | Topic marker | 저**는** 학생이에요 (As for me, I'm a student) |
| 이/가 | Subject marker | 비**가** 와요 (Rain is coming) |
| 을/를 | Object marker | 커피**를** 마셔요 (I drink coffee) |
| 에 | Location / time | 학교**에** 가요 (I go to school) |
| 에서 | Location of action | 집**에서** 공부해요 (I study at home) |
| 의 | Possession | 나**의** 책 (my book) |
| 도 | Also/too | 저**도** 가요 (I'm going too) |
| 한테/에게 | To (a person) | 친구**한테** 줘요 (I give it to a friend) |
...
1. A colleague has finished a full day of work: "Great job today + goodbye"
2. Someone (like a cashier) has done effort on your behalf: "Thank you for your effort"
